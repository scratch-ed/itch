...
function afterExecution() {
  const places = log.getSpriteLocations('Heks');
  ...
  const place1 = log.getSpriteLocations('Heks', frames1);
  const place2 = log.getSpriteLocations('Heks', frames2);
  const place3 = log.getSpriteLocations('Heks', frames3);
